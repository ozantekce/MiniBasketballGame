...
public class ShotScrollBar : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        red = transform.Find("Red").gameObject.GetComponent<Image>();
        yellow = transform.Find("Yellow").gameObject.GetComponent<Image>();
        green = transform.Find("Green").gameObject.GetComponent<Image>();

        text = transform.Find("PercentText").gameObject.GetComponent<TMP_Text>();
